...
title: 搞钱折腾记
summary: 作者毕业后尝试赚钱项目，先后考虑转卖VPN订阅和AI接口Token。因SubBoost无法实现用户管理而放弃梯子项目，转而购买服务器搭建NewAPI，汇集官方及其他中转站共5个上游，提供模型调用服务，并利用闲鱼自动发码销售兑换码。但遭遇批量操作不便、上游定价难控、成本回收困难等问题，整体属于低成本的摸索式创业，目前仍处草台阶段，前景未明。
date: 2026-08-11
tags:
  - NewAPI
  - 词元
